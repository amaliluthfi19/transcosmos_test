...
class MockHomeRestClient implements HomeRestClient {
  final List<SurahModel> _surahs;
  final Exception? _exception;

  MockHomeRestClient({List<SurahModel>? surahs, Exception? exception})
    : _surahs = surahs ?? [],
    ...
    group('getSurahs', () {
      test(
        ...
        () async {
          ...
          mockRestClient = MockHomeRestClient(surahs: surahModels);
          repository = HomeRepositoryImpl(mockRestClient);
      ...
      test(
        ...
        () async {
          // Arrange
          mockRestClient = MockHomeRestClient(surahs: []);
          repository = HomeRepositoryImpl(mockRestClient);
